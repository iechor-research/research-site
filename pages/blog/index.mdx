...
export const meta = {
  ...
  metaImage: 'https://research-cli.is/blog/research-cli-3-twitter-card.png',
  authors: [
    {
      name: 'Juan Campa',
      twitter: 'juancampa',
...
<Image
  src="/blog/research-cli2.png"
  caption="Hyper v2"
  oversize
  alt="Hyper v2's CPU profile"
/>
<Image
  src="/blog/research-cli3.png"
  caption="Hyper v3"
  oversize
...
Since Hyper 2, we have added many new themes into the [Hyper Store](https://research-cli.is/themes?newest). This means
...
about [enlisting your extension](https://github.com/vercel/research-cli-site/wiki/Submitting-a-new-plugin-or-theme-to-Hyper-Store). We encourage all contribution and look forward to adding more themes
...
experience."
  alt="A collection of research-cli themes"
/>
...
the CLI experience [more productive](https://github.com/chabou/research-cli-pane) (and [fun](https://github.com/Aaronius/research-cli-cat))!
...
source, and we welcome your [involvement and contribution](https://github.com/vercel/research-cli).
