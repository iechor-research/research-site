...
You can find instructions and details about the process of creating a new plugin or theme in the [Hyper repository](https://github.com/vercel/research-cli/blob/canary/PLUGINS.md).
